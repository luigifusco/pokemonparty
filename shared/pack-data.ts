...
export const PACK_TIERS: PackTierDef[] = [
  ...
  },
  {
    ...
    costMultiplier: 2.5,
    cards: 5,
    weights: { common: 30, uncommon: 45, rare: 18, epic: 7, legendary: 0 },
    guaranteedHighTier: false,
    bonusTmCount: 1,
    bonusItemCount: 1,
  },
  {
    ...
    costMultiplier: 6,
    cards: 7,
    weights: { common: 8, uncommon: 30, rare: 40, epic: 21, legendary: 1 },
  ...
  },
  {
    ...
    costMultiplier: 15,
    cards: 7,
    weights: { common: 0, uncommon: 8, rare: 30, epic: 57, legendary: 5 },
    guaranteedHighTier: true,
    bonusTmCount: 2,
    bonusItemCount: 2,
  },

...
export const PACKS: PackDef[] = [
  {
    ...
    tmPool: ['Surf', 'Hydro Pump', 'Aqua Tail', 'Scald', 'Muddy Water', 'Brine', 'Blizzard', 'Ice Beam'],
  ...
  },
  {
    ...
    tmPool: ['Fire Blast', 'Solar Beam', 'Will-O-Wisp', 'Outrage', 'Close Combat', 'Earthquake'],
  ...
  },
  {
    ...
    tmPool: ['Thunder', 'Thunderbolt', 'Wild Charge', 'Volt Tackle', 'Thunder Wave', 'Signal Beam'],
  ...
  },
  {
    ...
    tmPool: ['Earthquake', 'Stone Edge', 'Earth Power', 'Rock Slide', 'Dig', 'Iron Head'],
  ...
  },
  {
    ...
    tmPool: ['Shadow Ball', 'Dark Pulse', 'Psychic', 'Dream Eater', 'Nasty Plot', 'Calm Mind', 'Hypnosis'],
  ...
  },
  {
    ...
    tmPool: ['Outrage', 'Brave Bird', 'Hurricane', 'Fly', 'Air Slash', 'Dragon Dance', 'Aerial Ace'],
  ...
  },
  {
    ...
    tmPool: ['Blizzard', 'Ice Beam', 'Surf', 'Shadow Ball', 'Earthquake', 'Iron Head'],
  ...
  },
  {
    ...
    tmPool: ['Flash Cannon', 'Iron Head', 'Meteor Mash', 'Iron Defense', 'Earthquake', 'Stone Edge'],
  ...
  },
  {
    ...
    tmPool: ['Sludge Bomb', 'Gunk Shot', 'Bug Buzz', 'X-Scissor', 'Megahorn', 'Toxic', 'Poison Sting'],
  ...
  },
  {
    ...
    tmPool: ['Stone Edge', 'Earthquake', 'Rock Slide', 'Iron Head', 'Aqua Tail', 'Iron Defense'],
  ...
  },
  {
    ...
    tmPool: ['Body Slam', 'Double-Edge', 'Extreme Speed', 'Shadow Ball', 'Thunderbolt', 'Fire Blast', 'Swords Dance'],

...
function playTone(ac, freq, duration, type = 'sine', volume = 0.3, detune = 0) {
...
function playNoise(ac, duration, volume = 0.15) {
...
export function getMoveSfxType(moveName) {
...
const BGM_KANTO_TRAINER = { url: 'audio/hgss-kanto-trainer.mp3', loopStart: 13.003, loopEnd: 94.656 };
const BGM_KANTO_GYM = { url: 'audio/bw2-kanto-gym-leader.mp3', loopStart: 14.626, loopEnd: 58.986 };
const BGM_JOHTO_TRAINER = { url: 'audio/hgss-johto-trainer.mp3', loopStart: 23.731, loopEnd: 125.086 };
const BGM_ELITE4 = { url: 'audio/spl-elite4.mp3', loopStart: 3.962, loopEnd: 152.509 };
const BGM_CHAMPION_DPP = { url: 'audio/dpp-trainer.mp3', loopStart: 13.440, loopEnd: 96.959 };
const BGM_RIVAL_DPP = { url: 'audio/dpp-rival.mp3', loopStart: 13.888, loopEnd: 66.352 };
const BGM_HOENN_TRAINER = { url: 'audio/oras-trainer.mp3', loopStart: 13.579, loopEnd: 91.548 };
const BGM_HOENN_RIVAL = { url: 'audio/oras-rival.mp3', loopStart: 14.303, loopEnd: 69.149 };
const BGM_SINNOH_TRAINER = { url: 'audio/dpp-trainer.mp3', loopStart: 13.440, loopEnd: 96.959 };
const BGM_RED = { url: 'audio/bw2-kanto-gym-leader.mp3', loopStart: 14.626, loopEnd: 58.986 };
...
let currentBgm = null;
let bgmLoopHandler = null;
export function startBattleBgm(volume = 0.25, trainerId) {
    stopBattleBgm();
    try {
...
export function playHitSound(effectiveness, volume = 0.4) {
...
// --- Pokémon cries ---
const cryCache = {};
export function playCry(pokemonName, volume = 0.3, playbackRate = 1.0) {
    try {
...
export function preloadCries(pokemonNames) {
